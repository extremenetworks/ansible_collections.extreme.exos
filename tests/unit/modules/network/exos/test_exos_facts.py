...
from ansible_collections.extreme.exos.plugins.modules import exos_facts
...
class TestExosFactsModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extreme.exos.plugins.module_utils.network.exos.facts.legacy.base.run_commands')
